...
# match the output of pahole for struct memebers
# 
# for example `pahole list_head` outputs following, regexp PAT will match and capture:
#  - type=struct list_head *, name=next, offset=0
#  - type=struct list_head *, name=prev, offset=8
#
# ```bash
# $ pahole list_head
# struct list_head {
